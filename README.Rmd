...
knitr::opts_chunk$set(fig.path='img/', fig.width=6, fig.asp=0.618)
library("ggplot2")
library("dplyr")
```

```{r example, eval=FALSE, echo=FALSE}
# Set filename in the chunk name
# Can add additional options https://yihui.name/knitr/options/#plots for specific plots!
ggplot(data = mpg) +
...
```{r geom_examples, fig.show='hold', out.width=c('400px', '400px')}
...
```{r position_examples, fig.show='hold', out.width=c('400px', '400px')}
...
```{r scale_limit, fig.show='hold', out.width=c('400px', '400px')}
